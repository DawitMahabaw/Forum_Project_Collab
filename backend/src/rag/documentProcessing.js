...
// Full RAG pipeline: extract, chunk, embed, and store
const processDocument = async (documentId, filePath) => {
  try {
    ...
    // Generate embeddings and save chunks to DB
...
// Controller to register document and trigger background pipeline
